...
public class Properties {
    ...
    public void createPropertiesFile(){
        try{
            ...
            writer.write("#file types that program accepts as photos. Format: jpg,png,jpeg,gif,bmp\n");
            writer.write("$accepted_file_types=jpg,png,jpeg,gif,bmp\n");
            writer.write("#date format divider (default 1996-11-29): -\n");
            writer.write("$date_format_divider=-\n");
